...
from ghops.config import load_config, logger
from ghops.utils import run_command, find_git_repos_from_config
from ghops.render import render_docs_table
...
def get_docs_status(repo_path: str) -> Dict[str, any]:
    ...
    from ghops.utils import get_remote_url, parse_repo_url, detect_github_pages_locally
...
def docs_deploy(repo_path, branch, message, dry_run):
    ...
    try:
        ...
        from ghops.utils import get_remote_url, parse_repo_url
        remote_url = get_remote_url(repo_path)
